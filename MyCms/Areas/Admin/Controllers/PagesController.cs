...
namespace MyCms.Areas.Admin.Controllers
{
    ...
    public class PagesController : Controller
    {
        ...
        {
            ViewBag.GroupID = new SelectList(pageGrropRepository.GetAllGroups(), "GroupID", "GroupTitle");
            return View();
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.GroupID = new SelectList(pageGrropRepository.GetAllGroups(), "GroupID", "GroupTitle", page.GroupID);
            return View(page);
        }
